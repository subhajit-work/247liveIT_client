...
@Component({
  ...
  templateUrl: './call-tracking.page.html',
  styleUrls: ['./call-tracking.page.scss'],
})


export class CallTrackingPage implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.listing_url = 'CallsActivities';


        this.onHeaderData(this.headerUrlapi);

        this.api_parms = {
          userId: this.get_user_dtls.userId
        }
